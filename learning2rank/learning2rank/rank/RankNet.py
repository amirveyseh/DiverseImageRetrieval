...
from learning2rank.learning2rank.utils import plot_result
...
class RankNet(NNfuncs.NN):
    ...
    def loading(self, modeName, X):
        self.initializeModel(Model, X, 512, 128, "Adam")
        self.loadModel(modeName)
